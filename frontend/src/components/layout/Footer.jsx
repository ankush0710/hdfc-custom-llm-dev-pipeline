      ...
      <div className="flex flex-col gap-4 md:flex-row items-center justify-between px-6">
        ...
        <div>
          <ul className="flex gap-4">
            <li className="text-xs lg:text-md text-gray-400">Privacy Policy</li>
            <li className="text-xs lg:text-md text-gray-400">
              Terms of Service
            </li>
            <li className="text-xs lg:text-md text-gray-400">Security</li>
          </ul>
        </div>
      </div>
    </div>
