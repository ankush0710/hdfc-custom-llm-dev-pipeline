        ...
        <nav className="w-full bg-white border-b border-gray-200 px-4 py-3 shadow-sm">
            <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button className="p-1.5 text-black hover:text-blue-900 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer" aria-label="Toggle Sidebar">
                        <Menu className="w-8 h-8" />
                    </button>
                    <Link href="/" className="flex items-center gap-2 text-[#000000] font-bold text-lg tracking-tight">
                        <img src="/HDFC_Forge_logo.png" alt="logo" className="h-10 w-auto object-contain" />
                    </Link>
                </div>
                ...
                <div className="flex-1 max-w-md hidden md:block">
                    <div className="relative">
                        <Search className="w-8 h-8 md:h-6 w-6 absolute left-3 top-1/2 -translate-y-1/2 text-gray-400" />
                        <input
                            type="text"
                ...
                <div className="flex items-center gap-3">
                    <button className="p-2 text-black hover:text-blue-900 hover:bg-gray-100 rounded-lg transition-colors relative cursor-pointer" aria-label="Notifications">
                        <Bell className="w-8 h-8 md:h-6 w-6" />
                    ...
                    <button className="p-2 text-black hover:text-blue-900 hover:bg-gray-100 rounded-lg transition-colors cursor-pointer" aria-label="Settings">
                        <Settings className="w-8 h-8 md:h-6 w-6" />
                    </button>
                    ...
                    <div className="flex items-center gap-2 cursor-pointer p-1 hover:bg-gray-50 rounded-lg transition-colors">
                        <div className="w-12 h-12 rounded-full bg-blue-900 text-white flex items-center justify-between justify-center font-medium text-xs">
                            <User className="w-6 h-6 md:h-6 w-6" />
                        </div>
